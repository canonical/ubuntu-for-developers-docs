...
This guide explains how to install Clang and the LLVM toolchain on Ubuntu. Clang is a popular C and C++ compiler, and a part of the [LLVM project](https://llvm.org/).
